  ...
  _createClass(EuiLineSeries, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          color = _props.color,
          borderOpacity = _props.borderOpacity,
          rest = _objectWithoutProperties(_props, ['data', 'name', 'curve', 'onSeriesClick', 'onValueClick', 'showLineMarks', 'lineSize', 'lineMarkColor', 'lineMarkSize', 'color', 'borderOpacity']);
...
EuiLineSeries.propTypes = {
  ...
  borderOpacity: _propTypes2.default.number
};
